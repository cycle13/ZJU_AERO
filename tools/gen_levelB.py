...
LastEditTime: 2020-12-08 11:22:12
'''
...
def _get_weights_asp(hydrom, list_D, list_asp):
    '''
        ...
        Args:
            ...
            list_asp: list of aspect ratio (<1, side vs base for IITM; >1, base vs side for TM), 
            as level A database provided. But PDF are computed by inverse of aspect_ratio (>1, base vs side), 
            assuming that the list_asp is equally spaced in 'inverse of aspect_ratio' domain.
            
        Returns:
            weights_asp: a xarray of weights against list_D and list_asp (<1, side vs base for IITM; >1, 
            base vs side for TM), for integration in _integration_over_pdf.
    '''
