 ...
 * @Description: 
 * @Author: Hejun Xie
 * @Date: 2019-09-07 20:41:28
 * @LastEditors  : Hejun Xie
 * @LastEditTime : 2020-01-02 22:17:32
 */
 %module interpolation_c
 %{
 /* Put header files here or function declarations like below */
extern float* get_all_radar_pts(float *output, int len, float *coords_rad_pts, int crp_x, int crp_y, float *radar_heights, int rh_x, float *model_data, int md_x, int md_y, int md_z, float *model_heights, int mh_x, int mh_y, int mh_z, float *model_topo, int mt_x, int mt_y, float *llc_cosmo, int llc_cosmo_x, float *res_cosmo, int res_cosmo_x);
 %}
...
%apply (float* IN_ARRAY2, int DIM1, int DIM2) {(float *model_topo, int mt_x, int mt_y)}
