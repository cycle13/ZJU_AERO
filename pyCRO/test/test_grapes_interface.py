...
LastEditTime: 2020-11-02 16:30:52
'''
...
if __name__ == "__main__":
    ...
    a.load_model_file(data_file_list, time=dt.datetime(2019,11,29,3), load_pickle=LOAD_MODEL, pickle_file='mdl.pkl', nwp_name='grapes')
