...
LastEditTime: 2021-06-23 21:47:57
'''
...
if __name__ == "__main__":
	...
	ax.plot(np.logspace(-5, -2, ntest), dbZH_G, color='r', label='Graupel')
	ax.plot(np.logspace(-5, -2, ntest), dbZH_S, color='b', label='Snow')

	ax.set_xlabel(r'Ice water content [$kg m-3$]', fontsize=14)
	ax.set_ylabel(r'$Z_{H}$', fontsize=14)
	ax.set_xscale('log')
